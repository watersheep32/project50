...
input_label = Label(window, text="press tab to add a new transaction", fg=colours[1], bg=colours[2], font=(fonter, 13, "bold"))
input_label.grid(column=1, columnspan=2, pady=10)
window.bind('<KeyPress-Tab>', lambda event: add_entry(window))
window.title("h")
